...
export const DEFAULT_FEATURE_FLAGS: FeatureFlags = {
  enableVectorAI: true, // Enable for testing - can be disabled via environment variable
  enableAutoIndexing: true, // Enable for testing - can be disabled via environment variable
  enableContextRetrieval: true, // Enable for testing - can be disabled via environment variable
