...
import { FAMILY_PROTECTION_DISCOUNT_RATE } from './npvConfig';
...
export function calculateDeathBenefitMaxPV(
	...
	const paymentMode: PaymentFrequency = (paymentFrequency as PaymentFrequency) || 'Monthly'
	const increaseRateValue = increaseRate !== undefined ? increaseRate : 0
	// Use configured rate directly as a decimal (e.g., 0.055 for 5.5%)
	const discountRate = FAMILY_PROTECTION_DISCOUNT_RATE
