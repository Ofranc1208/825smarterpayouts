...
## 🔄 SMARTERPAYOUTS - COMPLETE 4-STEP PROCESS
...
export function getProcessContextHint(message: string): string {
  ...
  return `
💡 PROCESS CONTEXT: This question relates to ${categories.join(', ')}. Reference the Process Information section above for detailed step-by-step guidance, timelines, legal requirements, and state variations.`;
}
