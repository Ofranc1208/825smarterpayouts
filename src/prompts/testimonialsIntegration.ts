...
## 💬 SMARTERPAYOUTS - REAL CUSTOMER STORIES
...
**Roberto García - Miami, FL (5-star rating)**
...
export function getTestimonialsContextHint(message: string): string {
  ...
  return `
💡 TESTIMONIALS CONTEXT: This question relates to ${categories.join(', ')}. Reference the Customer Stories section above for real customer experiences, satisfaction metrics, and success stories.`;
}
