/**
 * Timing & Steps Direct Responses
 * 
 * Contains direct response mappings for process timing, steps,
 * and procedural questions.
 * 
 * @module directResponses/timing
 * @author SmarterPayouts Team
 * @since 2025
 */

export const TIMING_DIRECT_RESPONSES = `
📆 TIMING & STEPS:
...
When user asks "How long is my quote valid?" or "How long is the quote valid?" or "quote validity" or "how long does my quote last?" or similar:
