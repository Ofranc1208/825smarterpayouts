...
import styles from './GuaranteedNavigationButton.module.css';

/**
 * ============================================================================
 * GUARANTEED NAVIGATION BUTTON - SHARED COMPONENT
 * ============================================================================
 *
 * Circular arrow buttons for step navigation (back/next).
 * Provides consistent styling and behavior across all Guaranteed calculator steps.
 *
 * Features:
...
export interface GuaranteedNavigationButtonProps {
  direction: 'back' | 'next';
  disabled?: boolean;
  onClick?: () => void;
  type?: 'button' | 'submit';
...
const GuaranteedNavigationButton: React.FC<GuaranteedNavigationButtonProps> = ({
  direction,
  disabled = false,
  onClick,
  type = 'button',
...
export default GuaranteedNavigationButton;

// Export props interface for TypeScript users
export type { GuaranteedNavigationButtonProps };
