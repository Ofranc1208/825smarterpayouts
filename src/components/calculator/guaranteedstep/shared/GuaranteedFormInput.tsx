...
import styles from './GuaranteedFormInput.module.css';

/**
 * ============================================================================
 * GUARANTEED FORM INPUT - SHARED COMPONENT
 * ============================================================================
 *
 * Centralized form input component for Guaranteed calculator steps.
...
export interface GuaranteedFormInputProps {
  type: 'text' | 'date';
  value: string;
...
const GuaranteedFormInput: React.FC<GuaranteedFormInputProps> = ({
  type,
  value,
  onChange,
  placeholder,
...
export default GuaranteedFormInput;

// Export props interface for TypeScript users
export type { GuaranteedFormInputProps };
