...
/**
 * Hero Section Component for Mint Chat
 * 
 ...
 * 
 * Renders the top section of the Mint chat page with branding,
 * title, and description in a visually appealing layout.
 */
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <MintBadge variant="compact" style={{ marginBottom: "0.5rem" }} />
