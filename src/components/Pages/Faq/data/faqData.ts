 ...
 * FAQ Data
 * 
 * Comprehensive list of frequently asked questions about structured settlements
 */
...
export const faqData: FAQ[] = [
  ...
  {
    id: 13,
    question: "What are the main advantages of selling my structured settlement?",
    answer: "The primary advantages include immediate access to cash for urgent needs, debt consolidation at lower interest rates, investment opportunities, and maintaining financial flexibility while eliminating future payment uncertainties.",
    category: "Benefits"
  },
  {
    id: 14,
    question: "Can selling help with debt consolidation?",
    answer: "Yes, many clients use the lump sum to pay off high-interest debt like credit cards, personal loans, or medical bills. This can significantly reduce monthly payments and total interest paid over time.",
    category: "Benefits"
  },
  {
    id: 15,
    question: "What investment opportunities become available?",
    answer: "Selling your structured settlement provides capital for investments such as real estate, business opportunities, education, or retirement planning that may offer better returns than the discount rate of the sale.",
    category: "Benefits"
  },
  {
    id: 16,
    question: "How does selling provide financial flexibility?",
    answer: "A lump sum gives you control over your money. You can allocate funds based on current needs rather than being locked into predetermined payment schedules that may not match your changing circumstances.",
    category: "Benefits"
  },
  {
    id: 17,
    question: "Are there tax advantages to selling?",
    answer: "The tax treatment generally remains similar to your original structured settlement payments. However, having a lump sum provides more flexibility in tax planning strategies with professional guidance.",
    category: "Benefits"
  },
  {
    id: 18,
    question: "Can selling improve my credit score?",
    answer: "Using the lump sum to pay off existing debts can improve your debt-to-income ratio and credit utilization, potentially leading to better credit scores and more favorable lending terms in the future.",
    category: "Benefits"
  },
  {
    id: 19,
