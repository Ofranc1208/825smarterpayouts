/**
 * CTA Section Component - Privacy Page
 *
 * Final call-to-action section encouraging users to start securely.
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <Button
              as="a"
              href="/mint-chat-active?type=calculate&source=privacy-cta"
